...
import { useAppSelector, useInjectedService, useHospitalHooks } from "../../hooks";
import { ConfirmDeleteHospital, HospitalError, Spinner } from "../../components";
				...
				<>
					<div className="hospitalContent ">
						<div className="hospitalContent flex">
							...
							<div>
								<h2 className="hospital-name">{hospital?.name.toUpperCase()}</h2>
